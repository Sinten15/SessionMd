    ...
    _0x37e6f4['ev']['on'](_0x52617a(0x18a), async _0x3e98bf => {
        ...
        if (_0x361c11 == _0x2503b3(0x186)) {
            ...
            await _0x37e6f4['sendMessage'](_0x37e6f4[_0x2503b3(0x18e)]['id'], {
                ...
                'text': '🔴 Session Generator by Zidni ©2022',
                'contextInfo': {
                    'externalAdReply': {
        ...
        _0x361c11 === 'close' && _0x27bace && _0x27bace[_0x2503b3(0x18d)] && _0x27bace['error']['output'][_0x2503b3(0x180)] != 0x191 && ZidniCupid();
...
function _0x6d19() {
    const _0x1cca66 = ['default', 'Cupid Bot Inc', 'silent', '5syuYel', 'node-fetch', '🔥Dream Ngentod', '48381003rHXlIS', '5152244LYeTwr', 'application/json', '12211507qAdVTI', '554MkPcxB', 'rm -rf session.json', 'sendMessage', 'pino', 'SERV GENERATOR', '1888299sldnoW', 'statusCode', '8407400vVdiGK', 'messages.upsert', '3374553eKNfkn', '@adiwajshing/baileys', '2797HOoTpz', 'open', './session.json', 'exit', 'log', 'connection.update', '6kiMeSE', '10ZopOJR', 'error', 'user', '1.0.0', 'creds.update', 'Safari', 'preview', 'session.json'];
    _0x6d19 = function() {
        return _0x1cca66;
    };
    return _0x6d19();
